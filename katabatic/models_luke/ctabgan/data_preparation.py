"""
Data preparation module for CTAB-GAN
"""
...
class DataPrep(object):
    """Data preparation class for pre-processing and post-processing."""
    ...
    def __init__(
        ...
        # Split data if target column specified
        if problem_type:
        ...
        # Handle empty values in numeric columns
    ...
    def inverse_prep(self, data, eps=1):
        ...
        # Convert back -9999999 and "empty" to na
